 ...
 */
 angular.module('app')
 .constant('baseUrl','http://127.0.0.1:81/api');

 angular.module('app').constant('constantsUrl',{
     'listPod': 'listPod'
 }).service('FormatUrl',['baseUrl',function(baseUrl){
...
app.constant('JS_REQUIRES', {
    ...
    scripts: {
        ...
        //*** Controllers
        'dashboardCtrl': 'js/controller/dashboardCtrl.js',
        ...
        'userCtrl': ['js/controller/userCtrl.js'],
        ...
        'inboxCtrl': 'js/controller/inboxCtrl.js',
        'xeditableCtrl': 'assets/js/controllers/xeditableCtrl.js',
        'chatCtrl': 'js/controller/chatCtrl.js',
        'clusterCtrl': 'js/controller/clusterCtrl.js',

        //*** Filters
        'htmlToPlaintext': 'assets/js/filters/htmlToPlaintext.js',
        //*** Services
        'clusterSvc': 'js/service/clusterSvc.js'
    },
    //*** angularJS Modules
    modules: [{
        name: 'angularMoment',
