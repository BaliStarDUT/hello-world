...
import net.james.mysql.driver.packets.client.AuthSwitchResponsePacket;
import net.james.mysql.driver.packets.client.ClientAuthenticationPacket;
import net.james.mysql.driver.packets.client.QuitCommandPacket;
import net.james.mysql.driver.packets.server.*;
import net.james.mysql.driver.socket.SocketChannel;
import net.james.mysql.driver.socket.SocketChannelPool;
import net.james.mysql.driver.utils.MSC;
import net.james.mysql.driver.utils.MySQLPasswordEncrypter;
    ...
    public void connect() throws IOException {
        if (connected.compareAndSet(false, true)) {
            try {
                ...
                logger.info(String.format("connect MysqlConnection to {%s}...", address));
                negotiate(channel);
            } catch (Exception e) {
                disconnect();
            ...
            logger.info("the channel can't be connected twice.");
        }
    }
    ...
    public void disconnect() throws IOException {
        if (connected.compareAndSet(true, false)) {
            try {
                ...
                logger.info(String.format("disConnect MysqlConnection to {}...", address));
            } catch (Exception e) {
            ...
            if (dumping && connectionId >= 0) {
                ...
                try {
                    ...
                    // 忽略具体异常
                    logger.info("KILL DUMP " + connectionId + " failure"+e.getMessage());
                } finally {
                    if (connector != null) {
            ...
            logger.info(String.format("the channel {%s} is not connected", this.address));
        }
    }
